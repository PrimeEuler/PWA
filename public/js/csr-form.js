...
class FormField extends HTMLElement {
  ...
  static get observedAttributes() {
    ...
    var observe =  ["value", "label", "type", "error-message", "invalid"];
    console.log('observedAttributes', ["value", "label", "type", "error-message", "invalid"] );
    return observe;
  }

  connectedCallback() {
    console.log('connectedCallback', 'Custom FormField element added to page.');
