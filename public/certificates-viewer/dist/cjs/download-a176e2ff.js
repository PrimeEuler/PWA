...
var build = l10n.createCommonjsModule(function (module, exports) {
/**
...
var ipaddr = l10n.createCommonjsModule(function (module) {
(function (root) {
...
let AttributeValue = class AttributeValue extends DirectoryString {
    ...
    toString() {
        return this.ia5String || (this.anyValue ? index.Convert.ToHex(this.anyValue) : super.toString());
    }
};
__decorate([
...
exports.DisplayText = class DisplayText {
    constructor(params = {}) {
        Object.assign(this, params);
    }
    toString() {
...
class NoticeReference {
    constructor(params = {}) {
        this.organization = new exports.DisplayText();
        this.noticeNumbers = [];
        Object.assign(this, params);
    }
}
...
exports.CRLReason = class CRLReason {
...
exports.ExtendedKeyUsage = ExtendedKeyUsage_1 = class ExtendedKeyUsage extends AsnArray {
    constructor(items) {
        super(items);
...
exports.SubjectAlternativeName = SubjectAlternativeName_1 = class SubjectAlternativeName extends GeneralNames {
    constructor(items) {
        super(items);
...
exports.SubjectDirectoryAttributes = SubjectDirectoryAttributes_1 = class SubjectDirectoryAttributes extends AsnArray {
    constructor(items) {
        super(items);
...
class TBSCertificate {
    constructor(params = {}) {
        ...
        this.subject = new exports.Name$1();
...
class Name {
    constructor(data) {
        _asn.set(this, new exports.Name$1());
        if (index.BufferSourceConverter.isBufferSource(data)) {
            __classPrivateFieldSet(this, _asn, AsnParser.parse(data, exports.Name$1));
        }
        else {
...
const id_pe_biometricInfo = `${id_pe}.2`;
...
let CertificateApplicationPolicies = CertificateApplicationPolicies_1 = class CertificateApplicationPolicies extends exports.CertificatePolicies {
    constructor(items) {
        super(items);
...
exports.CaVersion = class CaVersion {
    constructor() {
        this.value = new ArrayBuffer(0);
    }
    toString() {
...
exports.NetscapeComment = class NetscapeComment {
    constructor(value) {
        this.value = "";
        if (value) {
            this.value = value;
...
exports.LeiChoice = class LeiChoice {
    constructor(value) {
...
__decorate([
    AsnProp({ type: AsnPropTypes.Utf8String })
], exports.LeiChoice.prototype, "text", void 0);
__decorate([
    AsnProp({ type: Lei })
...
exports.LeiRoles = class LeiRoles {
    constructor(value) {
        this.text = "";
        if (value) {
            this.text = value;
...
__decorate([
    AsnProp({ type: AsnPropTypes.Utf8String })
], exports.LeiRoles.prototype, "text", void 0);
exports.LeiRoles = __decorate([
    AsnType({ type: AsnTypeTypes.Choice })
], exports.LeiRoles);
...
class ByteStream {
    ...
    readNumber(size) {
        ...
        const hex = index.Convert.ToHex(bytes);
...
class Structure {
    static createStream(bytes) {
        const view = index.BufferSourceConverter.toUint8Array(bytes);
    ...
    constructor(raw) {
        ...
        switch (this.asn.extnID) {
            case id_pe_authorityInfoAccess:
                this.value = AsnParser.parse(asnExtnValue, exports.AuthorityInfoAccessSyntax);
                break;
            ...
            case id_ce_extKeyUsage:
                this.value = AsnParser.parse(asnExtnValue, exports.ExtendedKeyUsage);
                break;
            ...
            case id_ce_subjectDirectoryAttributes:
                this.value = AsnParser.parse(asnExtnValue, exports.SubjectDirectoryAttributes);
                break;
            case id_ce_subjectKeyIdentifier:
                this.value = AsnParser.parse(asnExtnValue, SubjectKeyIdentifier);
                break;
            case id_pe_qcStatements:
                this.value = AsnParser.parse(asnExtnValue, exports.QCStatements);
                break;
            case id_certificateTemplate:
                this.value = AsnParser.parse(asnExtnValue, CertificateTemplate);
                break;
            case id_enrollCertType:
                this.value = AsnParser.parse(asnExtnValue, exports.EnrollCertTypeChoice);
                break;
            case id_netscapeComment:
                this.value = AsnParser.parse(asnExtnValue, exports.NetscapeComment);
                break;
            case id_netscapeCertType:
                this.value = AsnParser.parse(asnExtnValue, NetscapeCertType);
                break;
            case id_caVersion:
                this.value = AsnParser.parse(asnExtnValue, exports.CaVersion);
                break;
            case id_certificateTransparency:
                this.value = AsnParser.parse(asnExtnValue, CertificateTransparency);
                break;
            case id_lei:
                this.value = AsnParser.parse(asnExtnValue, exports.LeiChoice);
                break;
            case id_lei_roles:
                this.value = AsnParser.parse(asnExtnValue, exports.LeiRoles);
                break;
            ...
            case id_pe_biometricInfo:
                this.value = AsnParser.parse(asnExtnValue, exports.BiometricSyntax);
                break;
            default:
...
const id_ntQWAC = "0.4.0.9496";

const id_ActivityDescription = `${id_ntQWAC}.6`;
exports.ActivityDescription = class ActivityDescription {
    constructor(params = {}) {
...
exports.DomainNameBeneficiary = class DomainNameBeneficiary extends DomainName {
    constructor(items) {
        super(items);
        Object.setPrototypeOf(this, exports.Name$1.prototype);
    }
...
exports.DomainNameLegalRepresentative = class DomainNameLegalRepresentative extends DomainName {
    constructor(items) {
        super(items);
        Object.setPrototypeOf(this, exports.Name$1.prototype);
    }
...
exports.DomainNameOwner = class DomainNameOwner extends DomainName {
    constructor(items) {
        super(items);
        Object.setPrototypeOf(this, exports.Name$1.prototype);
    }
...
exports.DomainNameTechnicalOperator = class DomainNameTechnicalOperator extends DomainName {
    constructor(items) {
        super(items);
        Object.setPrototypeOf(this, exports.Name$1.prototype);
    }
...
exports.InsuranceValue = class InsuranceValue {
    constructor(params = {}) {
        this.location = "";
        this.base = 0;
        this.degree = 0;
...
exports.ValuationRanking = class ValuationRanking {
    constructor(params = {}) {
        this.stars5 = 0;
        this.stars4 = 0;
        this.stars3 = 0;
...
exports.TypeRelationship = class TypeRelationship {
    constructor(params = {}) {
...
class PrivateKey extends OctetString$1 {
}
...
let EncryptedPrivateKeyInfo$1 = class EncryptedPrivateKeyInfo$1 extends EncryptedPrivateKeyInfo {
};
...
exports.id_DomainNameOwner = id_DomainNameOwner;
exports.id_DomainNameTechnicalOperator = id_DomainNameTechnicalOperator;
exports.id_InsuranceValue = id_InsuranceValue;
